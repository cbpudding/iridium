...
void ir_model_new_internal(ir_model *model) {
	...
	lua_pushstring(model->state, "matrix_index");
	lua_pushcfunction(model->state, ir_matrix_index_lua);
	lua_settable(model->state, -3);
	...
	lua_pushstring(model->state, "matrix_newindex");
	lua_pushcfunction(model->state, ir_matrix_newindex_lua);
	lua_settable(model->state, -3);
